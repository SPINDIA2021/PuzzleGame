...
public class MainActivity extends AppCompatActivity implements UtilsAwv.Listener, AppKeyContact.View {
    ...
    private AppKeyContact.Presenter presenter;
    ...
    public void adKeysResponse(ArrayList<AdKeysResponse> adKeysResponse) {
        ...
        {
            if (adKeysResponse.get(i).getName().equals("puzzle Interstitial ads"))
            {
                Preferences.saveValue(Preferences.Inter,adKeysResponse.get(i).getApikey());
                Preferences.saveValue(Preferences.AppID,adKeysResponse.get(i).getAppid());
            }else if (adKeysResponse.get(i).getName().equals("puzzle banner"))
            {
